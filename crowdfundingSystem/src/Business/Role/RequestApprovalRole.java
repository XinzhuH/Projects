 ...
 * @author Lenovo
 */
public class RequestApprovalRole extends Role{
     @Override
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise,  Network network,EcoSystem business, Employee employee) {
        return new ProjectApprovalWorkAreaJPanel(userProcessContainer, account, organization, enterprise,network, employee);
    }
     @Override
    public String toString() {
        return "Request Approval Role";
    }
}
